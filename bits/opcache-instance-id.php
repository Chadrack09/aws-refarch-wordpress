...
class OpCacheDataModel
{
    ...
    private function _getScriptStatus()
    {
        $this->_status = opcache_get_status(false);
    }

    private function _getScriptCache()
    {
        $this->_cache = opcache_get_status(true);
    }

    private function _getD3Scripts()
    {
        $this->_d3Scripts = array(
            'd3.v3.min.js',
            'd3.layout.cloud.js',
            'd3pie.min.js',
            'd3pie.js',
